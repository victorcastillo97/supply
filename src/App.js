...
import CreateItemProducto from './entities/Manufacturer/CreateItemProducto';
      ...
      return (
        <Router>
          <Switch>
            ...
            <Route exact path="/manufacturer/create-itemProducto" component={(() => <CreateItemProducto account={this.state.account} supplyChain={this.state.supplyChain} web3={this.state.web3} />)} />
            <Route exact path="/manufacturer/view-itemProductos" component={(() => <ViewItemProductos account={this.state.account} supplyChain={this.state.supplyChain} web3={this.state.web3} />)} /> */}
            {/* <Route exact path="/manufacturer/view-itemProducto/:id" component={ItemProductoInfo} />
