...
export default function WholesalerItemProductoInfo(props) {
    ...
    async function getItemProductoData() {
        ...
        let subcontractAddress = await supplyChain.methods.getSubContractWD(itemProductoAddress).call({ from: account });
    ...
    if (loading) {
        ...
        return (
            <div>
                ...
                <p>{details}</p>
                <Button variant="contained" color="primary" ><Link to={{ pathname: `/wholesaler/view-request/${itemProductoAddress}`, query: { address: itemProductoAddress, account: account, web3: web3, supplyChain: supplyChain } }}>View Requests</Link></Button>&nbsp;&nbsp;&nbsp;
