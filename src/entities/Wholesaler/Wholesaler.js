...
//                 <Button variant="contained" color="primary" onClick= {()=> this.handleClick()}>View Received ItemProducto</Button>
...
import ViewReceivedItemProducto from './ViewReceivedItemProducto';
import WholesalerReceiveProduct from './ReceiveProduct';
import RequestProductWholesaler from './RequestProduct';
import TransferItemProducto from './TransferItemProducto';
import ViewResponses from '../Events/ViewResponses';
import WholesalerItemProductoInfo from './WholesalerItemProductoInfo';
...
const routes = [
  {
    path: "/view-itemProductos",
    name: "View Received Product Item",
    icon: ViewItem,
    component: ViewReceivedItemProducto,
    layout: "/wholesaler"
  },
  {
  ...
  {
    path: "/transfer-itemProducto",
    name: "Transfer Product Item",
    icon: ViewTrans,
    component: TransferItemProducto,
    layout: "/wholesaler"
  },
  {
    path: "/receive-itemProducto",
    name: "Receive Product Item",
    icon: ViewTrans,
...
export default function Wholesaler({ ...rest }) {
  const switchRoutes = (
    <Switch>
      ...
      <Route exact path="/wholesaler/view-itemProducto/:id" component={WholesalerItemProductoInfo} />
