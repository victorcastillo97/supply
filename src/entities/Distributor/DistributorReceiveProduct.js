...
export default function DistributorReceiveProduct(props) {
  ...
  async function handleSubmit() {
    let itemProducto = new web3.eth.Contract(ItemProducto.abi, address);
    ...
    if(verificationOutput) {
      ...
      supplyChain.methods.distributorReceivedItemProducto(address, subcontractAddress, wholesaler, signature).send({from: account})
