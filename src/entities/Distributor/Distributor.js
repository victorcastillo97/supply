...
// import CreateItemProducto from './CreateItemProducto';
...
import DistributorViewReceivedItemProductos from './DistributorViewReceivedItemProductos';
import DistributorItemProductoInfo from './DistributorItemProductoInfo';
...
const routes = [
    ...
    },
    {
        ...
        name: "View Product Items",
        icon: ViewItem,
        component: DistributorViewReceivedItemProductos,
        layout: "/distributor"
    },
];
...
export default function Distributor({ ...rest }) {
    const switchRoutes = (
        <Switch>
            ...
            <Route exact path="/distributor/view-itemProducto/:id" component={DistributorItemProductoInfo} />
