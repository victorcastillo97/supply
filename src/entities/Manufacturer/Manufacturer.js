...
//              </ListItemIcon>
//         </ListItem>
//         <ListItem button key={'Create-ItemProducto'}>
//           <ListItemIcon>
//             <div>
//               <CollectionsIcon />
//               <Button href="/manufacturer/create-itemProducto" color="inherit">{'Create-ItemProducto'}</Button>
//             </div>
//           </ListItemIcon>
//         </ListItem>
//         </List>
...
import ViewItemProductos from './ViewItemProductos';
import ItemProductoInfo from './ItemProductoInfo';
...
const routes = [
  {
    path: "/create-itemProducto",
    name: "Create Product Item",
    icon: AddItem,
    component: CreateItemProducto,
    layout: "/manufacturer"
  },
  {
