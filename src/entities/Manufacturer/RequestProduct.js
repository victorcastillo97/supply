...
export default function RequestProductManufacturer(props) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    isLoading(true);
    const hashedMessage = web3.utils.sha3(signature);
    console.log("====== ga ======")
    ...
    supplyChain.methods.requestProduct(account, supplierAddress, rawMaterialAddress, signature2).send({ from: account })
