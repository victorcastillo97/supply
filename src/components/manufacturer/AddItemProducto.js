  ...
  return (
    <Router>
        ...
        <Container component="main" maxWidth="xs">
            ...
            <Typography component="h1" variant="h5">Enter ItemProducto Details</Typography>
            <form className={classes.form} noValidate>
            <Grid container spacing={2}>

                <Grid item xs={12}>
                    <TextField variant="outlined" required fullWidth  id="itemProducto-description" label="ItemProducto Desription" name="itemProducto-description"/>
                </Grid>
...
export default withRouter(AddItemProducto);